...
package com.fissy.deskclock.timer;
...
import com.fissy.deskclock.data.TimerListener;
import com.fissy.deskclock.data.TimerStringFormatter;
...
public final class TimerFragment extends DeskClockFragment {
    ...
    private static final String EXTRA_TIMER_SETUP = "com.fissy.deskclock.action.TIMER_SETUP";
