...
import com.fissy.deskclock.widget.selector.AlarmSelection;
import com.fissy.deskclock.widget.selector.AlarmSelectionAdapter;
...
public class AlarmSelectionActivity extends ListActivity {
    ...
    public static final String EXTRA_ACTION = "com.fissy.deskclock.EXTRA_ACTION";
    public static final String EXTRA_ALARMS = "com.fissy.deskclock.EXTRA_ALARMS";
    /**
