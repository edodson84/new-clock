...
import static com.fissy.deskclock.Utils.enforceMainLooper;
import static com.fissy.deskclock.Utils.enforceNotMainLooper;
...
import com.fissy.deskclock.Predicate;
...
public final class DataModel {
    ...
    public static final String ACTION_WORLD_CITIES_CHANGED =
            "com.fissy.deskclock.WORLD_CITIES_CHANGED";
    /**
            ...
            public void onClick(View v) {
                ...
                if (Utils.isLOrLater()) {
                    try {
                        ...
                        // fissy attempt only; recovery code below
                    }
                }
